...
class AutomationProvider
 ...
 protected:
  ...
  content::WebContents* GetViewForTab(int tab_handle);
  ...
  //CancelableRequestConsumer consumer_; //joek: removed this... doesn't look like it's used.
 ...
 private:
  ...
  // to handle the keys
  void ProcessUnhandledAccelerator(int handle,
                                   const MSG& msg);

  void SetInitialFocus(int handle, bool reverse,
