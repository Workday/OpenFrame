...
bool AutomationResourceMessageFilter::OnMessageReceived(
  ...
  bool handled = true;
  //joek: reverting this code back to c7fd73291df44ad9c03c04d8aba6e5d694bf2864 as e44d13473dd9d81a8d3e1d26f2024be4e4a7c503 removed IPC_BEGIN_MESSAGE_MAP_EX
  
  IPC_BEGIN_MESSAGE_MAP(AutomationResourceMessageFilter,
                           message)
