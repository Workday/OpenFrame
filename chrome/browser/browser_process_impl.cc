...
void BrowserProcessImpl::StartTearDown() {
  ...
  //joek: Removed this, as shutdown has been removed as dictionaries were moved to a per-profile implementation: 0c2207220bb2b4d9c927182c0aa520e2837bae5a
  //It was also removed from the underlying net\base\sdch_manager.h class
  //BrowserThread::PostTask(BrowserThread::IO, FROM_HERE,
  //                        base::Bind(&net::SdchDictionaryFetcher::Shutdown));
