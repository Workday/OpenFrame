...
class sessions::TabRestoreService;
...
class RecentlyClosedTabsHandler : public content::WebUIMessageHandler,
 ...
 public:
  ...
  // display to the user.
  virtual void TabRestoreServiceChanged(sessions::TabRestoreService* service) override;

  // Observer callback to notice when our associated TabRestoreService
  // is destroyed.
  virtual void TabRestoreServiceDestroyed(sessions::TabRestoreService* service) override;
