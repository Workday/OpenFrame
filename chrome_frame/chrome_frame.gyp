  ...
  'targets': [
    ...
    },
    {
      ...
      'dependencies': [
        ...
        '../chrome/chrome.gyp:chrome_initial',
        '../base/base.gyp:base',
        '../net/net.gyp:net',
      ],
    ...
    },
    {
      ...
      'dependencies': [
        ...
        'chrome_tab_idl',
        'locales/locales.gyp:*',
        '<(DEPTH)/components/components.gyp:browser_watcher_client',
      ...
      'sources': [
        ...
        'chrome_tab.rgs',
        'resource.h',
        '<(DEPTH)/chrome/app/chrome_watcher_client_win.cc',
        '<(DEPTH)/chrome/app/chrome_watcher_client_win.h',
        '<(DEPTH)/chrome/app/chrome_watcher_command_line_win.cc',
        '<(DEPTH)/chrome/app/chrome_watcher_command_line_win.h',
        '<(DEPTH)/chrome/chrome_watcher/chrome_watcher_main_api.cc',
        '<(DEPTH)/chrome/chrome_watcher/chrome_watcher_main_api.h',
        '<(DEPTH)/chrome/app/file_pre_reader_win.cc',
        '<(DEPTH)/chrome/app/file_pre_reader_win.h',
        '<(DEPTH)/components/startup_metric_utils/browser/pre_read_field_trial_utils_win.cc',
        '<(DEPTH)/components/startup_metric_utils/browser/pre_read_field_trial_utils_win.h',
        '<(DEPTH)/content/app/sandbox_helper_win.cc',
        '<(DEPTH)/content/public/app/sandbox_helper_win.h',
      ],
      'conditions': [
        ['OS=="win"', {
          # NOTE(slightlyoff):
