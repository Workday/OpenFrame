...
class CreateExternalTabContext
 ...
 public:
  typedef base::Tuple<HWND, HWND, int, int> output_type;
...
class BeginNavigateContext
 ...
 public:
  ...
  typedef base::Tuple<AutomationMsg_NavigationResponseValues> output_type;
...
class UnloadContext
    : public SyncMessageReplyDispatcher::SyncMessageCallContext {
 public:
  typedef base::Tuple<bool> output_type;
