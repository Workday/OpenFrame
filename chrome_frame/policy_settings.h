...
class PolicySettings {
 public:
  ...
  const base::CommandLine& AdditionalLaunchParameters() const;
 ...
 protected:
  PolicySettings()
      : default_renderer_(RENDERER_NOT_SPECIFIED),
        ...
        additional_launch_parameters_(base::CommandLine::NO_PROGRAM),
 ...
 protected:
  ...
  base::CommandLine additional_launch_parameters_;
  bool suppress_turndown_prompt_;

 private:
  // This ensures no construction is possible outside of the class itself.
  friend struct base::DefaultSingletonTraits<PolicySettings>;
