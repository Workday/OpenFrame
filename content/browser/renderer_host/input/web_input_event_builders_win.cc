...
WebKeyboardEvent WebKeyboardEventBuilder::Build(HWND hwnd,
  ...
  DLOG(INFO) << "WebKeyboardEventBuilder::Build blue";
  ...
  DLOG(INFO) << "WebKeyboardEventBuilder::Build 0";

  switch (message) {
  case WM_SYSKEYDOWN:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build a";
    result.isSystemKey = true;
  case WM_KEYDOWN:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build b";
    result.type = WebInputEvent::RawKeyDown;
    break;
  case WM_SYSKEYUP:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build c";
    result.isSystemKey = true;
  case WM_KEYUP:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build d";
    result.type = WebInputEvent::KeyUp;
    break;
  case WM_IME_CHAR:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build e";
    result.type = WebInputEvent::Char;
    break;
  case WM_SYSCHAR:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build f";
    result.isSystemKey = true;
    result.type = WebInputEvent::Char;
  case WM_CHAR:
	  DLOG(INFO) << "WebKeyboardEventBuilder::Build g";
    result.type = WebInputEvent::Char;
    break;
  default:
    NOTREACHED();
  }
  DLOG(INFO) << "WebKeyboardEventBuilder::Build 1";
  ...
  DLOG(INFO) << "WebKeyboardEventBuilder::Build 2";
  ...
  DLOG(INFO) << "WebKeyboardEventBuilder::Build 3";

  DLOG(INFO) << "WebKeyboardEventBuilder::Build end";
  return result;
}
